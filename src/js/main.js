...
(async () => {
  ...
  const manageSubButtons = headerComponent.querySelectorAll(
    ".manage__button--sub"
  );
  ...
  enrollOpenButton.addEventListener("click", () => {
    ...
    modifyButtonEls.forEach((modifyButton) => {
      ...
      modifyButton.parentNode
        .querySelector(".modify--confirm__button")
        .classList.add("hide");
      modifyButton.parentNode
        .querySelector(".modify__close-icon")
        .classList.add("hide");
    });
  ...
  enrollConfirmButton.addEventListener("click", () => {
    ...
    const itemModifyConfirmButton = flexItem.querySelector(
      ".modify--confirm__button"
    );
  ...
  modifyButtonEls.forEach((modifyButton) => {
    modifyButton.addEventListener("click", (event) => {
      ...
      const modifyConfirmButton = clickedParentEl.querySelector(
        ".modify--confirm__button"
      );
      const closeModifyIcon = clickedParentEl.querySelector(
        ".modify__close-icon"
      );
    ...
    const closeModifyIcon = modifyButton.parentNode.querySelector(
      ".modify__close-icon"
    );
  ...
  let modifyConfirmButtonEls = document.querySelectorAll(
    ".modify--confirm__button"
  );
